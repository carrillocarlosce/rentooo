  ...
  render() {
    return (
			...
			<View style={styles.navContainer}>
				...
				<TouchableOpacity>
					<Image
						style={styles.rightNavBtn} resizeMode={'contain'}
				...
				<View style={styles.descriptionContainer}>
					...
					<View style={{marginTop: 16}}>
						<Text style={styles.descriptionContent}>
							Lorem ipsum dolor sit amet, consectetur adipis elit. Fusce vestibulum dapibus tempus. Aliquam dapibus sit amet neque eget volutpat. In Haege habitasse platea dictumst. Sed eget pharetraut tellus. Sed interdum dictum volutpat. Nunc ut varius odio, a ullamcorper duitiam ut euismod metus, in eleifend lacus.
						</Text>
			...
			<View style={styles.bottomAbContainer}>
				<View>
					...
					<View style={styles.currencyContainer2}>
						<Image style={styles.currency2} resizeMode="contain" source={require('../../assets/images/rentoo.png')}/>
						<Image style={styles.currency} resizeMode="contain" source={require('../../assets/images/bitcoin.png')}/>
					</View>
				</View>
